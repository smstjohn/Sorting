...
public class Sorts {
   ...
   static public void swap(int index1, int index2) {
    ...
    // Swaps the integers at locations index1 and index2 of the values array. 
      ...
      values[index2] = temp;
      swapCounter++; //added a counter to use in getSwapCount method
   }
   ...
   public static int getComparesCount() {
   ...
   public static void main(String[] args) {
      ...
      selectionSort();
      printValues();
      System.out.println("selectionSort\tswaps: " + getSwapCount() + "\tcompares: " + getComparesCount());
      System.out.println("values is sorted: " + isSorted());
      System.out.println();
      ...
      printValues();
      shortBubble();
      System.out.println("shortBubble\tswaps: " + getSwapCount() + "\tcompares: " + getComparesCount());
      System.out.println("values is sorted: " + isSorted());
      System.out.println();
      ...
      printValues();
      bubbleSort();
      System.out.println("bubbleSort\tswaps: " + getSwapCount() + "\tcompares: " + getComparesCount());
      System.out.println("values is sorted: " + isSorted());
      System.out.println();
      ...
      printValues();
      insertionSort();
      System.out.println("insertionSort\tswaps: " + getSwapCount() + "\tcompares: " + getComparesCount());
      System.out.println("values is sorted: " + isSorted());
      System.out.println();
